...
class Interceptor extends \Magento\Paypal\Model\Hostedpro implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllowedCcTypes');
        return $pluginInfo ? $this->___callPlugins('getAllowedCcTypes', func_get_args(), $pluginInfo) : parent::getAllowedCcTypes();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getReturnUrl');
        return $pluginInfo ? $this->___callPlugins('getReturnUrl', func_get_args(), $pluginInfo) : parent::getReturnUrl($storeId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getNotifyUrl');
        return $pluginInfo ? $this->___callPlugins('getNotifyUrl', func_get_args(), $pluginInfo) : parent::getNotifyUrl($storeId);
    }
    ...
    public function getCancelUrl($storeId = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getCancelUrl', func_get_args(), $pluginInfo) : parent::getCancelUrl($storeId);
    }
