...
class Interceptor extends \Magento\Paypal\Model\Method\Agreement implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'initBillingAgreementToken');
        return $pluginInfo ? $this->___callPlugins('initBillingAgreementToken', func_get_args(), $pluginInfo) : parent::initBillingAgreementToken($agreement);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBillingAgreementTokenInfo');
        return $pluginInfo ? $this->___callPlugins('getBillingAgreementTokenInfo', func_get_args(), $pluginInfo) : parent::getBillingAgreementTokenInfo($agreement);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'placeBillingAgreement');
        return $pluginInfo ? $this->___callPlugins('placeBillingAgreement', func_get_args(), $pluginInfo) : parent::placeBillingAgreement($agreement);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'updateBillingAgreementStatus');
        return $pluginInfo ? $this->___callPlugins('updateBillingAgreementStatus', func_get_args(), $pluginInfo) : parent::updateBillingAgreementStatus($agreement);
    }
