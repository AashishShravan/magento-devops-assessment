...
class Interceptor extends \Magento\Paypal\Model\Payflow\Transparent implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getResponceValidator()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getResponceValidator', func_get_args(), $pluginInfo) : parent::getResponceValidator();
    }
    ...
    public function getConfigInterface()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getConfigInterface', func_get_args(), $pluginInfo) : parent::getConfigInterface();
    }
