...
class Interceptor extends \Magento\Paypal\Model\Adminhtml\Express implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function authorizeOrder(\Magento\Sales\Api\Data\OrderInterface $order)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'authorizeOrder');
        return $pluginInfo ? $this->___callPlugins('authorizeOrder', func_get_args(), $pluginInfo) : parent::authorizeOrder($order);
    }

    /**
     * {@inheritdoc}
     */
    public function isOrderAuthorizationAllowed(\Magento\Sales\Model\Order\Payment $payment): bool
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isOrderAuthorizationAllowed');
        return $pluginInfo ? $this->___callPlugins('isOrderAuthorizationAllowed', func_get_args(), $pluginInfo) : parent::isOrderAuthorizationAllowed($payment);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCheckoutRedirectUrl');
        return $pluginInfo ? $this->___callPlugins('getCheckoutRedirectUrl', func_get_args(), $pluginInfo) : parent::getCheckoutRedirectUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getApi');
        return $pluginInfo ? $this->___callPlugins('getApi', func_get_args(), $pluginInfo) : parent::getApi();
    }
