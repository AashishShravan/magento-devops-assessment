...
class Interceptor extends \Magento\OfflinePayments\Model\Checkmo implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPayableTo');
        return $pluginInfo ? $this->___callPlugins('getPayableTo', func_get_args(), $pluginInfo) : parent::getPayableTo();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMailingAddress');
        return $pluginInfo ? $this->___callPlugins('getMailingAddress', func_get_args(), $pluginInfo) : parent::getMailingAddress();
    }
