...
class Interceptor extends \Magento\OfflinePayments\Model\Cashondelivery implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInstructions');
        return $pluginInfo ? $this->___callPlugins('getInstructions', func_get_args(), $pluginInfo) : parent::getInstructions();
    }
