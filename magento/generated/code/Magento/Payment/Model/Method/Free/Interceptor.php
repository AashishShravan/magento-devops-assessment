...
class Interceptor extends \Magento\Payment\Model\Method\Free implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAvailableInConfig');
        return $pluginInfo ? $this->___callPlugins('isAvailableInConfig', func_get_args(), $pluginInfo) : parent::isAvailableInConfig($quote);
    }
